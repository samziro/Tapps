    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <img
              src="https://readdy.ai/api/search-image?query=Modern%20clean%20chicken%20coop%20facility%20in%20Kenya%20with%20healthy%20white%20broiler%20chickens%20in%20spacious%20natural%20environment%2C%20proper%20ventilation%2C%20clean%20feeding%20areas%2C%20and%20professional%20farming%20setup%20showcasing%20high-quality%20poultry%20management%20practices&width=600&height=500&seq=quality-standards&orientation=landscape"
              alt="Quality Standards"
              className="w-full h-[400px] object-cover object-top rounded-2xl shadow-xl"
            />
          </div>
          <div>

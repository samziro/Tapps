...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://tapps-kappa.vercel.app/og-image.jpg", // Add real image inside /public
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://tapps-kappa.vercel.app/og-image.jpg"],
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: "https://tapps-kappa.vercel.app/og-image.jpg",
            }),
          }}
        />
      </head>
